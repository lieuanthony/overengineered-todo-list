...
export default function DatePicker({ value, onChange, placeholder = "Set due date", inputStyle }: DatePickerProps) {
  ...
  const navBtn = (onClick: () => void, children: React.ReactNode) => (
    <button onClick={onClick} style={{ background: "none", border: "none", cursor: "pointer", color: muted, padding: "4px 8px", borderRadius: 6, fontFamily: "inherit", fontSize: 14, display: "flex", alignItems: "center", transition: "color 0.15s" }}
    ...
    <div ref={containerRef} style={{ position: "relative", display: "inline-block" }}>
      ...
      <button
        ...
        style={{
          ...
          cursor: "pointer", background: bg, border: `1px solid ${open ? accent : border}`,
          borderRadius: 8, padding: "6px 12px", fontSize: 12,
          color: displayValue ? text : muted, fontFamily: "inherit",
      ...
      {open && (
        <div style={{
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", marginBottom: 4 }}>
            {DAYS.map(d => (
              <div key={d} style={{ textAlign: "center", fontSize: 11, color: muted, fontFamily: "inherit", padding: "2px 0" }}>{d}</div>
            ))}
          </div>
              ...
              <div key={i} style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                {day === null ? null : (
                  <button
                    ...
                    onMouseEnter={e => { if (!isSelected(day)) e.currentTarget.style.background = border; }}
