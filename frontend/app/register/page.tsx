        ...
        >
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              <label style={{ fontSize: 12, fontWeight: 500, color: text, fontFamily: 'inherit' }}>
                Name
              </label>
              <input
                type="text"
            ...
            {error && (
              <p style={{ margin: 0, fontSize: 12, color: '#e53e3e', fontFamily: 'inherit' }}>
                {error}
              </p>
            )}
